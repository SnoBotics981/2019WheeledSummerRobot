...
AddOutputFilter chunkFilter
		...
		<Item Name="981LabViewComponents" Type="Folder">
			...
			<Item Name="Arm Position Spreadsheet.xlsx" Type="Document" URL="../../981LabViewComponents/Arm Position Spreadsheet.xlsx"/>
			<Item Name="Arm Position.docx" Type="Document" URL="../../981LabViewComponents/Arm Position.docx"/>
			<Item Name="Arm Pot Controller.vi" Type="VI" URL="../../981LabViewComponents/Arm Pot Controller.vi"/>
			<Item Name="Auto Arm Pot Controller.vi" Type="VI" URL="../../981LabViewComponents/Auto Arm Pot Controller.vi"/>
			<Item Name="Auto Mode Alternate 2.vi" Type="VI" URL="../../981LabViewComponents/Auto Mode Alternate 2.vi"/>
			<Item Name="C1191000" Type="Document" URL="../../981LabViewComponents/C1191000"/>
			<Item Name="Calculate Pot Value For Arm at Zero Degrees.vi" Type="VI" URL="../../981LabViewComponents/Calculate Pot Value For Arm at Zero Degrees.vi"/>
			<Item Name="ControlSpreadsheet.csv" Type="Document" URL="../../981LabViewComponents/ControlSpreadsheet.csv"/>
			<Item Name="CoPilotControlFlow.vi" Type="VI" URL="../../981LabViewComponents/CoPilotControlFlow.vi"/>
			<Item Name="Create CVS Control Spreadsheet.vi" Type="VI" URL="../../981LabViewComponents/Create CVS Control Spreadsheet.vi"/>
			<Item Name="Current Monitoring Logic.docx" Type="Document" URL="../../981LabViewComponents/Current Monitoring Logic.docx"/>
			<Item Name="DisplayCurrentValues.vi" Type="VI" URL="../../981LabViewComponents/DisplayCurrentValues.vi"/>
			<Item Name="Fancy Light Controller.vi" Type="VI" URL="../../981LabViewComponents/Fancy Light Controller.vi"/>
			<Item Name="Global Arm Variables.vi" Type="VI" URL="../../981LabViewComponents/Global Arm Variables.vi"/>
			<Item Name="Global Teleop Variables.vi" Type="VI" URL="../../981LabViewComponents/Global Teleop Variables.vi"/>
			...
			<Item Name="Init Drive Motors With CVS File.vi" Type="VI" URL="../../981LabViewComponents/Init Drive Motors With CVS File.vi"/>
			<Item Name="Init Drive Motors.vi" Type="VI" URL="../../981LabViewComponents/Init Drive Motors.vi"/>
			<Item Name="Init Fancy Lights With CVS File.vi" Type="VI" URL="../../981LabViewComponents/Init Fancy Lights With CVS File.vi"/>
			<Item Name="Init Global Arm Variables.png" Type="Document" URL="../../981LabViewComponents/Init Global Arm Variables.png"/>
			<Item Name="Init Global Arm Variables.vi" Type="VI" URL="../../981LabViewComponents/Init Global Arm Variables.vi"/>
			<Item Name="Init Joystics.vi" Type="VI" URL="../../981LabViewComponents/Init Joystics.vi"/>
			<Item Name="Init Raspberry Pi With CVS File.vi" Type="VI" URL="../../981LabViewComponents/Init Raspberry Pi With CVS File.vi"/>
			...
			<Item Name="Lift Controller.vi" Type="VI" URL="../../981LabViewComponents/Lift Controller.vi"/>
			...
			<Item Name="Pot To Arm Angle.vi" Type="VI" URL="../../981LabViewComponents/Pot To Arm Angle.vi"/>
			<Item Name="Power Monitor.vi" Type="VI" URL="../../981LabViewComponents/Power Monitor.vi"/>
			<Item Name="Read Arm Pot and Encoder Values.vi" Type="VI" URL="../../981LabViewComponents/Read Arm Pot and Encoder Values.vi"/>
			<Item Name="ReadCsvControlSpreadsheet.vi" Type="VI" URL="../../981LabViewComponents/ReadCsvControlSpreadsheet.vi"/>
			<Item Name="README.md" Type="Document" URL="../../981LabViewComponents/README.md"/>
			<Item Name="Set Arm or Winch Global.vi" Type="VI" URL="../../981LabViewComponents/Set Arm or Winch Global.vi"/>
			<Item Name="Shift Controller.vi" Type="VI" URL="../../981LabViewComponents/Shift Controller.vi"/>
			<Item Name="SpreadSheetGlobal.vi" Type="VI" URL="../../981LabViewComponents/SpreadSheetGlobal.vi"/>
			<Item Name="This PC - Shortcut.lnk" Type="Document" URL="../../981LabViewComponents/This PC - Shortcut.lnk"/>
			<Item Name="Wait MS.vi" Type="VI" URL="../../981LabViewComponents/Wait MS.vi"/>
			<Item Name="wait.png" Type="Document" URL="../../981LabViewComponents/wait.png"/>
			<Item Name="Winch Controller.vi" Type="VI" URL="../../981LabViewComponents/Winch Controller.vi"/>
			<Item Name="~$Arm Position Spreadsheet.xlsx" Type="Document" URL="../../981LabViewComponents/~$Arm Position Spreadsheet.xlsx"/>
			<Item Name="~WRL0004.tmp" Type="Document" URL="../../981LabViewComponents/~WRL0004.tmp"/>
		</Item>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Init Lift Motor With CVS File.vi" Type="VI" URL="../../981LabViewComponents/Init Lift Motor With CVS File.vi"/>
